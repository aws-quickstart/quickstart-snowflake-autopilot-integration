...
:partner-product-name: Snowflake Autopilot Integration
...
:quickstart-contributors: Bosco Albuquerque, AWS Data and Analytics team, and Dave May, AWS Integration & Automation team
